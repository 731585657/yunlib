require.config({
    ...
    paths: {
        ...
        'umjquery': '../addons/umeditor/umeditor/third-party/jquery.min',
        'umconfig': '../addons/umeditor/umeditor/umeditor.config',
        'ummin': '../addons/umeditor/umeditor/umeditor.min',
        'umlang': '../addons/umeditor/umeditor/lang/zh-cn/zh-cn',
...
//        'selectpage': ['css!../libs/fastadmin-selectpage/selectpage.css'],
        ...
        'ummin': ['umconfig','umjquery','css!../addons/umeditor/umeditor/themes/default/css/umeditor.css'],
        'umlang': ['ummin']
